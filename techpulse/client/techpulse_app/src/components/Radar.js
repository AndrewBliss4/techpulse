  ...
  return (
    <div style={{ width: '100%', height: '900px', display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', flexDirection: 'row', flex: 1 }}>
        ...
        {/* Right Container */}
        {selectedField && (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', marginLeft: '20px', height: '100%' }}>
            {/* Timeline Graph */}
            <div style={{ flex: 1, height: '50%', marginBottom: '20px' }}>
            ...
            {/* Rationale and Sources Text Box */}
            <div style={{
              flex: 1,
              height: '50%',
              padding: '15px',
